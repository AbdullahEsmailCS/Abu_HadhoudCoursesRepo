...
public:
	...
	void displayContactInfo() const {
		std::cout << "Phone Number (Mobile): " << phoneNumber.mobile << std::endl;
		std::cout << "Phone Number (Landline): " << phoneNumber.landline << std::endl;
		std::cout << "Primary Email: " << emailAddress.primary << std::endl;
		std::cout << "Secondary Email: " << emailAddress.secondary << std::endl;
		std::cout << "Home Address: " << homeAddress.street << ", "
			<< homeAddress.city << ", " << homeAddress.state << ", "
			<< homeAddress.zipCode << ", " << homeAddress.country << std::endl;
		std::cout << "Mailing Address: " << mailingAddress.street << ", "
			<< mailingAddress.city << ", " << mailingAddress.state << ", "
			<< mailingAddress.zipCode << ", " << mailingAddress.country << std::endl;
		std::cout << "Facebook: " << socialMediaProfiles.facebook << std::endl;
		std::cout << "Twitter: " << socialMediaProfiles.twitter << std::endl;
		std::cout << "LinkedIn: " << socialMediaProfiles.linkedIn << std::endl;
		std::cout << "Instagram: " << socialMediaProfiles.instagram << std::endl;
	}
};
